...
export declare const goatTestnet3: {
    readonly id: 48816;
    readonly name: "GOAT Testnet3";
...
export declare const goatPublicClient: {
    account: undefined;
    batch?: {
...
export declare function getGoatWalletClient(): {
    account: {
        address: Address;
 ...
 */
export declare function createDCAConfigGoat(params: CreateDCAParamsGoat): Promise<{
    configId: bigint;
    txHash: Hash;
}>;
export declare function pauseDCAConfigGoat(configId: bigint): Promise<Hash>;
export declare function resumeDCAConfigGoat(configId: bigint): Promise<Hash>;
export declare function cancelDCAConfigGoat(configId: bigint): Promise<Hash>;
/**
 ...
 */
export declare function executeDCAOrdersGoat(): Promise<{
    txHash: Hash;
...
export declare function getDCAConfigGoat(configId: bigint): Promise<DCAConfigDataGoat>;
export declare function getActiveDCAConfigsGoat(): Promise<bigint[]>;
/**
 ...
 */
export declare function getAllDCAConfigsGoat(): Promise<bigint[]>;
export declare function getUserDCAConfigsGoat(userAddress: Address): Promise<bigint[]>;
/** Deployer wallet's native BTC balance on GOAT Testnet3 — used for a health check. */
export declare function getGoatDeployerBalance(): Promise<bigint>;
/** Minimum BTC balance below which the scheduler should stop trying to pay gas. */
export declare const MIN_GOAT_BALANCE = 1000000000n;
//# sourceMappingURL=chain-goat.d.ts.map